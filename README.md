...
The prototype proved that the architecture works. The refactor will fix the known issues, improve security, replace Docker-based static serving with direct nginx delivery, and clean up the codebase before adding new members to the project.

**Microservice architecture (planned)**

The platform will be broken into independent services. Each service owns its domain, communicates over a message broker, and can be deployed and scaled independently.
...
This is also the direction for the final year B.Tech CSE project. The prototype was built to validate that the concept works at all. The microservice version will be built by a 5-person team with the architecture already understood from building it the hard way first.
...
Rahul Kumar — built the prototype solo.  
GitHub: [rahulkumar6777](https://github.com/rahulkumar6777)

The rest of the team joined after the prototype was complete and will be building the production version together.
