...
const SubscriptionPaymentGateway = ({ months, description , plan , amount }) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const { data: orderData } = await api.post("/subscription/init", {
        months,
        plan
      });
...
export default SubscriptionPaymentGateway;